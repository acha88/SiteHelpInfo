 ...
 */
final class Version20220428093244 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE planning CHANGE description description LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE adresse_mail adresse_mail LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
